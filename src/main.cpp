...
uint256 hashGenesisBlock("0xe00d8ed303cc2903ce886ebb3715d61dd58dfabcb23a776af900c36b0bbc98da");
...
const string strMessageMagic = "MaximusCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // MaximusCoin: 1 days
static const int64 nTargetSpacing = 120; // MaximusCoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal maximuscoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "MaximusCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x45ca9facadf8c86b371ee872c0665d1fa8d8d98448aa6fd3b96fc0e60151bf34");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1507749351; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1308386;

        if (fTestNet)
        {
            block.nTime    = 1507398211;
            block.nNonce   = 163408;
        }
